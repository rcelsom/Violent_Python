...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr 19 22:31:34 2019

@author: rcelsom

description: This script gets skype contacts and information
"""
...
def main():
    ...
    parser.add_option('-p', dest = 'pathName', type='string', \
                      help = 'specify skype profile name')
